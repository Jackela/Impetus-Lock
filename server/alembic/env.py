...
- Article I (Simplicity): Uses Alembic's standard async patterns
- Article IV (SOLID - SRP): Pure configuration, no business logic
...
async def run_async_migrations() -> None:
    ...
    This is required for asyncpg driver.
    """
