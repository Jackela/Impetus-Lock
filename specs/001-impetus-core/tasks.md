...
- [X] T019 [P] [US1] Write contract test for POST /impetus/generate-intervention in server/tests/test_intervention_api.py:
...
- [X] T027 [US1] Implement POST /impetus/generate-intervention endpoint in server/server/api/routes/intervention.py:
...
- [X] T028 [US1] Register intervention route in server/server/api/main.py FastAPI app (register unversioned route)
