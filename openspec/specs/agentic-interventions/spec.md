...
Enables AI-driven writing interventions through a structured API that generates provoke, rewrite, and delete actions with unique lock IDs, supporting multiple LLM providers with BYOK configuration and contract versioning.
