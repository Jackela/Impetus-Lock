...
Provides an intelligent writing editor that executes AI interventions atomically, applies source-aware styling to locked content, manages LLM provider configuration, and persists documents with optimistic versioning.
